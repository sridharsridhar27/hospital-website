...
const TrustBadge = React.memo(({ label }) => (
  <motion.div
    ...
    className="
      ...
      rounded-full
      border
      border-swasthic-primary/20
      bg-gradient-to-r
      from-swasthic-primary/10
      to-emerald-500/10
      px-4
      py-2
      text-xs
...
const StatCard = React.memo(({ value, label }) => (
  <motion.div
    ...
    className="
      ...
      transition-all
      duration-300
      hover:border-swasthic-primary/30
      hover:bg-white
      hover:shadow-md
    "
  >
    <p
      className="
        ...
        text-swasthic-text
        transition-colors
        group-hover:text-swasthic-primary
        sm:text-3xl
      "
    >
      {value}
    ...
    <p className="mt-1 text-xs font-medium text-swasthic-muted">
      {label}
    </p>
  </motion.div>
));
      ...
      <div className="relative w-full max-w-md lg:max-w-none">
        ...
        <motion.div
          ...
          className="
            ...
            transition-all
            duration-500
            hover:shadow-swasthic-primary/10
          "
        >
          {/* Main Image Wrapper */}
          <div
  ...
  return (
    <section
      ...
      className="
        ...
        overflow-hidden
        bg-gradient-to-b
        from-swasthic-background
        via-white
        to-swasthic-background
        py-12
        lg:py-20
      "
    >
