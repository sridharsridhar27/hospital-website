...
function ConditionCard({ condition }) {
  ...
  return (
    <motion.div variants={ITEM_VARIANTS} layout>
      <Link
      ...
      >
        ...
        <div className="flex items-center justify-end border-t border-slate-100 bg-slate-50/50 px-5 py-3.5">
          <div className="inline-flex items-center gap-1 text-xs font-bold text-[#0E5C4E] group-hover:text-[#0B483D]">
...
export default function Conditions() {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-50/50 px-4 py-16 sm:px-8 lg:px-12">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        {error && (
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="mx-auto mt-12 max-w-lg rounded-2xl border border-red-200 bg-red-50/80 p-6 text-center backdrop-blur-sm"
          >
            ...
            <button
              ...
              type="button"
              className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-red-600 px-4 py-2 text-xs font-bold text-white shadow-md transition-all hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            >
