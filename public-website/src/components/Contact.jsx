...
const GOOGLE_MAPS_EMBED_URL = 'https://www.google.com/maps?q=Swasthik%20Health%20Care%2C%20211%2C%201st%20Main%20Road%2C%20M.R.%20Nagar%2C%20Kodungaiyur%2C%20Chennai%20600118&output=embed';
...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-[#0E5C4E]/5 px-4 py-16 sm:px-8 lg:px-12 antialiased text-slate-900"
    >
      {/* ===================================================================
          BACKGROUND AMBIENT DECORATIONS
      =================================================================== */}
      <div 
        className="pointer-events-none absolute -left-40 top-1/4 h-[400px] w-[400px] rounded-full bg-[#0E5C4E]/10 blur-[100px]" 
        aria-hidden="true" 
      />
      <div 
        className="pointer-events-none absolute -right-40 bottom-1/4 h-[400px] w-[400px] rounded-full bg-[#0E5C4E]/10 blur-[100px]" 
        aria-hidden="true" 
      />
      <div
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <address className="mt-2 text-xs leading-relaxed text-slate-600 not-italic">
                {CONTACT_INFO.address.line1}
                <br />
                {CONTACT_INFO.address.line2}
                <br />
                <span className="font-semibold text-slate-800">{CONTACT_INFO.address.city}</span>
              </address>
            </div>
            ...
            <div className="relative z-10 mt-6 border-t border-slate-100 pt-3">
              ...
              >
                ...
                <div className="flex h-5 w-5 items-center justify-center rounded bg-[#0E5C4E]/10 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5">
                  <ArrowUpRight className="h-3 w-3 text-[#0E5C4E]" aria-hidden="true" />
                </div>
              </a>
            </div>
          </motion.article>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1.5 rounded-md bg-[#0E5C4E]/10 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#0E5C4E]">
                  <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#0E5C4E]" aria-hidden="true" />
                  Available Now
                </span>
              </div>
              ...
              <div className="mt-3 space-y-1.5">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-slate-400">Phone</span>
                    <span className="text-xs font-bold text-slate-800 group-hover/link:text-[#0E5C4E]">{CONTACT_INFO.phone.display}</span>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-slate-400">WhatsApp</span>
                    <span className="text-xs font-bold text-slate-800 group-hover/link:text-[#0E5C4E]">{CONTACT_INFO.whatsapp.display}</span>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="flex flex-col overflow-hidden">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-slate-400">Email Desk</span>
                    <span className="truncate text-xs font-bold text-slate-800 group-hover/link:text-[#0E5C4E]">{CONTACT_INFO.email}</span>
                  </div>
                </a>
              </div>
            </div>
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="rounded-lg border border-[#0E5C4E]/15 bg-[#0E5C4E]/5 p-2.5">
                  <div className="flex items-center gap-1 text-[#0E5C4E]">
                    <ShieldCheck className="h-3 w-3 shrink-0 text-[#0E5C4E]" aria-hidden="true" />
                    <p className="text-[10px] font-bold leading-tight">{CLINIC_SCHEDULE.specialty.label}</p>
                  </div>
        ...
        <motion.div
          ...
          className="relative mt-10 overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-2 shadow-xl shadow-slate-100"
        >
          {/* FLOATING LOCATION BADGE */}
          <div className="absolute left-6 top-6 z-20 hidden items-center gap-3 rounded-xl border border-white/80 bg-white/90 p-3 shadow-md backdrop-blur-md sm:flex">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0E5C4E] text-white">
              <Navigation className="h-4 w-4" aria-hidden="true" />
            </div>
            <div>
              <div className="flex items-center gap-1">
                <Sparkles className="h-3 w-3 text-[#0E5C4E]" aria-hidden="true" />
                <p className="text-xs font-bold text-slate-900">Swasthik Health Care</p>
              </div>
              <p className="text-[10px] font-medium text-slate-500">Kodungaiyur, Chennai</p>
            </div>
          </div>
          ...
          <div className="absolute bottom-6 left-1/2 z-20 flex -translate-x-1/2 items-center justify-center">
            <a
              href={GOOGLE_MAPS_URL}
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Open Swasthik Health Care in Google Maps external app"
              className="group inline-flex items-center gap-2.5 rounded-xl bg-[#0E5C4E] px-6 py-3 text-xs font-bold tracking-wide text-white shadow-lg shadow-[#0E5C4E]/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#0B483D] hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0E5C4E]"
            >
