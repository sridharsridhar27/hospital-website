          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={idx} className="flex items-start gap-3">
                <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#0E5C4E]/10 text-[#0E5C4E]">
    ...
    questions: [
      {
        ...
        answer: (
          <div className="space-y-3">
            ...
            <div className="grid gap-3 rounded-2xl border border-slate-100 bg-slate-50/50 p-4 sm:grid-cols-2">
      ...
      },
      {
        ...
        answer: (
          <div className="space-y-2">
            ...
            <p className="rounded-xl border border-amber-200/60 bg-amber-50/50 px-4 py-2 text-xs font-medium text-amber-700">
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="border-t border-slate-100 bg-slate-50/40 px-5 pb-6 pt-4 text-sm leading-relaxed text-slate-600 sm:px-6 sm:text-base">
              {answer}
            </div>
          </motion.div>
        )}
...
function FAQ() {
  ...
  return (
    <section
      id="faq"
      className="relative overflow-hidden bg-gradient-to-b from-slate-50/50 via-white to-slate-50/30 px-6 py-20 text-slate-800 sm:px-10 lg:px-16"
    >
      {/* Soft Ambient Background Lighting */}
      <div className="pointer-events-none absolute -left-32 top-1/4 h-[400px] w-[400px] rounded-full bg-[#0E5C4E]/5 blur-[100px]" />
      <div className="pointer-events-none absolute -right-32 bottom-1/4 h-[400px] w-[400px] rounded-full bg-[#FF6B45]/5 blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 rounded-full border border-slate-200/80 bg-white px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-[#0E5C4E] shadow-sm"
          >
          ...
          <motion.h2
            ...
            className="mt-4 font-[Space_Grotesk] text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl"
          >
        ...
        <div className="mt-10 flex justify-center">
          <div className="flex w-full max-w-2xl flex-wrap justify-center gap-1.5 rounded-2xl border border-slate-200/70 bg-slate-100/60 p-1.5 backdrop-blur-sm">
        ...
        <motion.div
          ...
          className="mx-auto mt-8 rounded-3xl border border-slate-200/70 bg-white/60 p-5 shadow-sm backdrop-blur-sm sm:p-8"
        >
          {/* Category Banner */}
          <div className="mb-6 flex items-center gap-3 rounded-xl bg-[#0E5C4E]/5 p-4">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#0E5C4E] text-white">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative mt-10 overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-7 shadow-lg shadow-slate-100 sm:p-8"
        >
          ...
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#0E5C4E]/10 text-[#0E5C4E]">
            ...
            <a
              href="tel:+919884507412"
              className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-[#0E5C4E] px-5 py-3 text-xs font-semibold text-white shadow-md shadow-[#0E5C4E]/20 transition-all hover:bg-[#0B483D] hover:shadow-lg sm:text-sm"
            >
